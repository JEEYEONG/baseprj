...
<form method="post" action="/signUp">
  <div class="container">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputName" name="userNm" placeholder="사용자 이름">
    </div>
    <div class="form-group">
      <label for="inputPassword">비밀번호</label>
      <input type="password" class="form-control" id="inputPassword" name="secretNum" placeholder="사용자 비밀번호">
    </div>
<%--    <div class="form-group">--%>
...
<%--      <input type="text" class="form-control" id="inputDiv" name="userDiv" placeholder="user, admin">--%>
<%--    </div>--%>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputGroup" name="authGroupCd" placeholder="권한 그룹 코드">
    </div>
